...
public class DaoProveedores {
    ...
    public boolean registrarProveedor(int nroDoc, String nombres, String apellidos, String direccion, int telefono) {
        sv.Conexion();
        boolean band = false;
        String sql = "insert into proveedores (prov_nom,prov_ape,prov_doc,prov_direc,prov_tel) values ('"+nombres+"','"+apellidos+"',"+nroDoc+",'"+direccion+"',"+telefono+")";
        System.out.println(sql);
        try {
            band = true;
            sv.st = sv.con.prepareStatement(sql);
